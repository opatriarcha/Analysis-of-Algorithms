...
set CLASSPATH=%APP_HOME%\lib\simulator.jar

@rem Execute simulator
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SIMULATOR_OPTS%  -classpath "%CLASSPATH%" vom.weisertech.simulator.MainApp %CMD_LINE_ARGS%
